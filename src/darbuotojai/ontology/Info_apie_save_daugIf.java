...
*/
public interface Info_apie_save_daugIf extends jade.content.Concept {
   ...
   */
   ...
   public Iterator getAllInfo_apie_save_vienetas();
   public List getInfo_apie_save_vienetas();
   public void setInfo_apie_save_vienetas(List l);
